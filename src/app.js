...
//----------------------- PARTE PRACTICA -----------------------------
  ...
  // a)
  let inventarioSinTrampa = inventario.filter(elemento => elemento !== "trampa")
  ...
  for (let i = 0; i < inventarioSinTrampa.length; i++) {
    inventarioEnMayusculas[i] = inventarioSinTrampa[i].toUpperCase()
  }
